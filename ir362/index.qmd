...
```{=html}
<img src="../assets/img/banners/ir362-banner.svg" alt="IR 362 banner with regional actor map" style="width:100%;border-radius:14px;margin-bottom:1.5rem;box-shadow:0 8px 24px rgba(122,31,31,0.15);" />
```
...
```{=html}
<section class="focus-card primary compact-start">
  <p class="eyebrow">For exam day</p>
  <h3>Start with the Exam Day Path.</h3>
  <p>Six steps in order — drill, walk through, outline, cram, breathe, walk in. This page is the deeper reference; open it after the first two.</p>
  <div class="focus-actions">
    <a href="exam-day.html">Open Exam Day</a>
    <a href="memorize.html">Open Memorize</a>
    <a href="cram-sheet.html">Open Cram Sheet</a>
  </div>
</section>
```
...
<div class="q-grid-legend">
  ...
  <span class="swatch" style="background:#7a1f1f"></span> Pivot (API↔Accords)
  <span class="swatch" style="background:#c79100"></span> Carousel (Nash)
  <span class="swatch" style="background:#4a1010"></span> Iran linkage
</div>
<div class="q-grid">
