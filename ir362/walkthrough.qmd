...
<svg viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Four-actor best-response diagram">
  ...
  <g font-family="Georgia, serif" font-size="14" text-anchor="middle">
    <circle cx="100" cy="80" r="40" fill="#7a1f1f" opacity="0.9"/>
    <text x="100" y="85" fill="#c79100" font-weight="700">Israel</text>
    <circle cx="380" cy="80" r="40" fill="#7a1f1f" opacity="0.9"/>
    <text x="380" y="85" fill="#c79100" font-weight="700">Palestinians</text>
    <circle cx="100" cy="240" r="40" fill="#7a1f1f" opacity="0.9"/>
    <text x="100" y="245" fill="#c79100" font-weight="700">Iran</text>
    <circle cx="380" cy="240" r="40" fill="#7a1f1f" opacity="0.9"/>
    <text x="380" y="245" fill="#c79100" font-weight="700">Saudi/Gulf</text>
  </g>
  <g stroke="#7a1f1f" stroke-width="1.6" fill="none" marker-end="url(#arr)">
...
<svg viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="The carousel of escalation and de-escalation">
  ...
  <g class="carousel-rotate">
    <circle cx="240" cy="160" r="120" fill="none" stroke="#7a1f1f" stroke-width="2" stroke-dasharray="6 4"/>
    <g stroke="#7a1f1f" stroke-width="1.8" fill="none">
  ...
  <g font-family="Georgia, serif" font-size="13" text-anchor="middle" fill="#3a3a3a">
    <text x="240" y="48" font-weight="700" fill="#7a1f1f">Escalation</text>
    <text x="376" y="166" font-weight="700" fill="#7a1f1f">War</text>
    <text x="240" y="288" font-weight="700" fill="#7a1f1f">Ceasefire</text>
    <text x="104" y="166" font-weight="700" fill="#7a1f1f">Normalization talks</text>
...
<svg viewBox="0 0 520 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Iran's land-bridge chain">
  ...
  <g font-family="Georgia, serif" font-size="13" text-anchor="middle" font-weight="700">
    <rect x="20" y="80" width="80" height="40" rx="8" fill="#7a1f1f"/><text x="60" y="105" fill="#c79100">Iran</text>
    <rect x="130" y="80" width="100" height="40" rx="8" fill="#7a1f1f"/><text x="180" y="105" fill="#c79100">Iraq Shia</text>
    <rect x="260" y="80" width="100" height="40" rx="8" fill="#7a1f1f" opacity="0.55"/><text x="310" y="100" fill="#c79100">Syria</text><text x="310" y="114" fill="#c79100" font-size="9">(pre-Dec 2024)</text>
    <rect x="390" y="80" width="110" height="40" rx="8" fill="#7a1f1f"/><text x="445" y="100" fill="#c79100">Hezbollah</text><text x="445" y="114" fill="#c79100" font-size="9">S. Lebanon</text>
  </g>
  <g stroke="#7a1f1f" stroke-width="2" fill="none" marker-end="url(#arr)">
